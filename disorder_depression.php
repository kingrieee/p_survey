<?php
    ...
    $query="SELECT * FROM depression_data";
	...
	<header>
		...
		<aside id="colorlib-hero">
			<div class="flexslider">
				<ul class="slides">
			   	<li style="background-image: url(images/depression.jpg);">
			   		<div class="overlay">
			   		<div class="container">
			   			<div class="row">
		                    	...
		                    	<tbody>
		                    		<?php while ($row=mysqli_fetch_array($result)) {?>
	                    				<tr style="font-size: 15px">
	                    					...
	                    					<td scope="col-md-10 "><?php echo $row['depression_question'] ?></td>
	                    					<td scope="col-md-10 "><?php echo $row['depression_choices'] ?></td>
	                    					<td scope="col" align="center"><input type="radio" name="depression" id="" value="1"></td>
                                    		<td scope="col" align="center"><input type="radio" name="depression" id="" value="2"></td>
                                    		<td scope="col" align="center"><input type="radio" name="depression" id="" value="3"></td>
                                    		<td scope="col" align="center"><input type="radio" name="depression" id="" value="4"></td>
                                    		<td scope="col" align="center"><input type="radio" name="depression" id="" value="5"></td>
	                    				</tr>	
	                    			<?php } ?>
		                    	</tbody>
	                        </table>
