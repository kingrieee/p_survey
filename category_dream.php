			...
			<div class="container">
				<div class="row">
					<div class="col-md-5 animate-box">
						<img class="img-responsive img-about" src="images/dreams.jpg" alt="#">
						<img class="img-responsive img-about" src="images/sleep.jpg" alt="#">
					</div>
						<div class="row">
							<div class="col-md-6">
								<p>A <strong>DREAM </strong>is a succession of images, ideas, emotions, and sensations that usually occur involuntarily in the mind during certain stages of sleep. <strong>Dream Interpretation</strong> is the attempt at drawing meaning from dreams and searching for an underlying message. The scientific study of dreams is called oneirology.</p>
							</div>
							<div class="col-md-6">
